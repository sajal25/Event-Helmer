...
class EventOrganizersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create event_organizer" do
    assert_difference('EventOrganizer.count') do
      post event_organizers_url, params: { event_organizer: { about: @event_organizer.about, address: @event_organizer.address, contact: @event_organizer.contact, email: @event_organizer.email, name: @event_organizer.name, website: @event_organizer.website } }
    end
  ...
  test "should update event_organizer" do
    patch event_organizer_url(@event_organizer), params: { event_organizer: { about: @event_organizer.about, address: @event_organizer.address, contact: @event_organizer.contact, email: @event_organizer.email, name: @event_organizer.name, website: @event_organizer.website } }
